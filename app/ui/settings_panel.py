...
class SettingsPanel(QWidget):
    ...
    def __init__(self):
        ...
        mark.addRow(QLabel("Position, size and opacity: select Watermark in Layers."))
        video = section("Video / new screenshot defaults")
        self.video_info = QLabel()
        video.addRow(self.video_info)
        field(video,"video_settings","comment_max_width_ratio","New image width ratio","float",.1,1)
        field(video,"video_settings","comment_y_ratio","New image center Y","float",0,1)
